...
├── README.md                          # 本文件 (中文)
├── README.en.md                       # 英文版 (English version)
...
- [SKILL.en.md](./SKILL.en.md) — English entry point for international users
...
```bash
# Codex — 告诉 Codex:
"帮我从 GitHub 拉取 johnnyzhao5619/BestSerenitySkillFromAT 并把根目录的 SKILL.md 安装为 skill"
...
# Cursor
git clone https://github.com/johnnyzhao5619/BestSerenitySkillFromAT.git /tmp/serenity && cp /tmp/serenity/SKILL.md .cursor/rules/serenity-unified.mdc

# Gemini CLI
git clone https://github.com/johnnyzhao5619/BestSerenitySkillFromAT.git /tmp/serenity && cp /tmp/serenity/SKILL.md GEMINI.md
```
