...
- **对象路由**: 单只票 -> 单股报告结构 (见 `templates/single-stock-report.md`)；一条赛道/板块 -> 赛道报告结构 (见 `templates/sector-report.md`)。两者都走最后一步强制独立复核。
...
> 供应链地图参考: `knowledge/supply-chain-map.md`
...
> A 股取数纪律 (巨潮资讯/业绩预告/问询函等) 详见 `knowledge/market-adaptation.md`
